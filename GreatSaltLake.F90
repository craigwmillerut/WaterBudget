...
!     Last change: SOU 9/30/2013 7:08:27 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
CALL WETLND(2)
QX(17,J,K)=QX(1,J,K)-QX(16,J,K)
!QIN(10,J,K)=29000.
QX(18,J,K)=MAX(0.0,MIN(SMX(1)*.75-STO(1),QX(17,J,K)))
CALL REINI(1)
QX(19,J,K)=QX(17,J,K)-QX(18,J,K)
CALL WETLND(1)
QX(15,J,K)=QX(2,J,K)-QX(14,J,K)
QX(11,J,K)=QX(3,J,K)+QX(4,J,K)
CALL WETLND(3)
