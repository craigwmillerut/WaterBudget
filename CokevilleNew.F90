...
!     Last change: SOU 2/23/2015 10:23:48 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!Upper Division Lands
CALL ARSUB(1)
QX(5,J,K)=QX(3,J,K)-QX(4,J,K)
DIFF=QX(10,J,K)-(QX(7,J,K)+QX(9,J,K))
DIFFBEF = DIFF
IF (ABS(DIFF) .gt. 0.3) THEN
        ...
        QX(5,J,K)= 0.0
        QX(7,J,K)= 0.0
        !QX(2,J,K)=MAX(0,QX(2,J,K)+Diff)
        QX(2,J,K)=QX(2,J,K)+Diff
        QX(3,J,K)=QX(1,J,K)+QX(2,J,K)
        CALL ARSUB(1)
        QX(5,J,K)=QX(3,J,K)-QX(4,J,K)
        DIFF=QX(10,J,K)-(QX(7,J,K)+QX(9,J,K))
...
QX(33,J,K)=QX(17,J,K)+QX(32,J,K)
CALL ARSUB(4)
QX(40,J,K)=QX(39,J,K)+QX(37,J,K)

!Riparian
CALL WETLND(1)
DIFF=QIN(5,J,K)-(QX(40,J,K)-QX(41,J,K))
!DIFFBEF = DIFF
