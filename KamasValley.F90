...
!     Last change: SOU 10/2/2012 11:49:28 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
REAL (KIND=8)::RSFLOW,DIFF,DEM13,WET13,AR13
!-----------------------------------------------------------------------
!     SAMPLE CODE FOR GENERAL MODEL
!-----------------------------------------------------------------------
CALL MUNSUB(2)
QX(20,J,K)=QX(19,J,K)+QX(17,J,K)
!Weber Provo Canal Div
QX(22,J,K)=QX(20,J,K)-QX(21,J,K)
CALL ARSUB(2)
QX(28,J,K)=QX(27,J,K)+QX(26,J,K)
!Inflow into rockport res
RSFLOW=RSBAK(1)
DEM13=DMDMD(1)
WET13=WETDMD(1)
AR13=ARDEM(1)
QX(31,J,K)=RSFLOW
QX(1,J,K)=RSFLOW-QX(28,J,K)+WET13+DEM13+AR13
CALL MUNSUB(1)
QX(6,J,K)=QX(5,J,K)+QX(3,J,K)
CALL ARSUB(1)
QX(12,J,K)=QX(11,J,K)+QX(10,J,K)
CALL WETLND(1)
QX(14,J,K)=QX(12,J,K)-QX(13,J,K)
 DIFF=RSFLOW-QX(28,J,K)-QX(14,J,K)
...
END IF
QX(37,J,K)=QX(33,J,K)+QX(34,J,K)
CALL MUNSUB(3)
QX(42,J,K)=QX(41,J,K)+QX(39,J,K)
CALL ARSUB(3)
QX(36,J,K)=QX(47,J,K)+QX(46,J,K)
!Balancing flow
QX(35,J,K)=QX(48,J,K)-QX(36,J,K)
