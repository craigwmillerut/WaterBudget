...
!     Last change: SOU 10/8/2013 9:12:44 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
QX(1,J,K)=QX(18,J,K)+DMDMD(1)+WETDMD(1)+ARDEM(1)+QX(2,J,K)
...
CALL ARSUB(1)
DIFF=QX(18,J,K)-QX(15,J,K)-QX(14,J,K)
IF (ABS(DIFF).GT.0.5) THEN
  QX(1,J,K)=QX(1,J,K)+DIFF
  QX(3,J,K)=QX(3,J,K)+DIFF
  QX(5,J,K)=QX(5,J,K)+DIFF
  CALL MUNBAK(1)
  CALL ARBAK(1)
CALL MUNSUB(1)
QX(10,J,K)=QX(9,J,K)+QX(8,J,K)
QX(21,J,K)=QX(20,J,K)+QX(2,J,K)
CALL ARSUB(1)
END IF
RETURN
END
