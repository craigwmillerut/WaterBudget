...
!     Last change: CWM 10/9/2012 3:58:31 PM
!     ******************************************************************
...
!-----------------------------------------------------------------------
!     Cottonwood Creek CODE FOR Indian Creek Water Budget MODEL
!-----------------------------------------------------------------------
QX(2,J,K)=QX(3,J,K)+QX(1,J,K)
CALL REINI(1)
QX(22,J,K)=QX(4,J,K)+QX(21,J,K)
CALL ARSUB(1)
