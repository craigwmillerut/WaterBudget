...
!     Last change: CWM 1/13/2012 11:52:29 AM
!     ******************************************************************
...
!-----------------------------------------------------------------------
!     SANTA CLARA WATER BUDGET MODEL
!-----------------------------------------------------------------------
QX(3,J,K)=QX(1,J,K)+QX(2,J,K)
!QX4 IS THE PINTO CREEK EXPORT
QX(5,J,K)=QX(3,J,K)-QX(4,J,K)
!PINE VALLEY AG AREA 1
CALL ARSUB(1)
QX(12,J,K)=QX(10,J,K)+QX(11,J,K)
!ADD SANTA CLARA AND FORSITH CREEK FOR QX15
QX(15,J,K)=QIN(3,J,K)+QIN(4,J,K)
QX(16,J,K)=QX(15,J,K)+QX(12,J,K)
!PINE VALLEY MUNICIPAL
CALL MUNSUB(1)
QX(21,J,K)=QX(18,J,K)+QX(20,J,K)
QX(26,J,K)=QX(21,J,K)+QX(22,J,K)+QX(23,J,K)+QX(24,J,K)
!CENTRAL TOWN MUNICIPAL (INCLUDES PRIVATE DOMESTIC)
CALL MUNSUB(2)
QX(31,J,K)=QX(30,J,K)+QX(28,J,K)
!CALCULATE REACH GAIN/LOSS FOR SANTA CLARA NEAR CENTRAL
QX(32,J,K)=QIN(13,J,K)-QX(31,J,K)
QX(33,J,K)=QX(31,J,K)+QX(32,J,K)
CALL ARSUB(2)
QX(40,J,K)=QX(38,J,K)+QX(39,J,K)
CALL REINI(1)
CALL ARSUB(4)
QX(50,J,K)=QX(48,J,K)+QX(47,J,K)
QX(54,J,K)=QX(41,J,K)+QX(50,J,K)+QX(51,J,K)+QX(52,J,K)+QX(53,J,K)
CALL ARSUB(3)
QX(62,J,K)=QX(59,J,K)+QX(60,J,K)
CALL MUNSUB(3)
QX(66,J,K)=QX(64,J,K)+QX(65,J,K)
QX(68,J,K)=0.0
