...
!     Last change: CWM 7/30/2012 4:00:04 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
QX(17,J,K)=QX(15,J,K)+ARDEM(1)+DMDMD(1)
QX(1,J,K)=QX(17,J,K)
CALL ARSUB(1)
...
CALL WETLND(1)
DIFF=QX(15,J,K)-QX(13,J,K)+QX(14,J,K)
DIFFBEF=1.E9
IF (ABS(DIFF).GE.0.1) THEN
  DO
    CALL ARBAK(1)
    QX(3,J,K)=0.0
    QX(5,J,K)=0.0
    QX(17,J,K)=QX(17,J,K)+DIFF
    QX(1,J,K)=QX(17,J,K)
    CALL ARSUB(1)
    ...
    DIFFBEF=DIFF
    DIFF=QX(15,J,K)-QX(13,J,K)+QX(14,J,K)
    IF (ABS(DIFF).GE.0.1.OR.ABS(DIFFBEF-DIFF).LE.0.1) THEN
      EXIT
    END IF
  END DO
END IF
