...
!     Last change: EJ 10/4/2012 3:13:40 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
CALL REINI(1)
CALL MUNSUB(1)
QX(15,J,K)=QX(13,J,K)+QX(12,J,K)
QX(26,J,K)=ARDEM(2)*0.30
QX(27,J,K)=QX(26,J,K)+QX(15,J,K)
CALL ARSUB(1)
QX(3,J,K)=QX(1,J,K)-QX(2,J,K)
QX(7,J,K)=QX(5,J,K)+QX(6,J,K)
CALL ARSUB(2)
QX(17,J,K)=QX(27,J,K)-QX(16,J,K)
QX(22,J,K)=QX(20,J,K)+QX(19,J,K)
CALL WETLND(1)
QX(24,J,K)=QX(22,J,K)-QX(23,J,K)
QX(25,J,K)=QX(24,J,K)+QX(7,J,K)
RETURN
END
