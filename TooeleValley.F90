...
!     Last change: SOU 3/27/2014 12:17:02 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
CALL REINI(1)
QX(35,J,K)=ARDEM(1)*0.45
QX(36,J,K)=QX(2,J,K)+QX(35,J,K)
CALL ARSUB(1)
QX(9,J,K)=QX(6,J,K)+QX(7,J,K)
CALL MUNSUB(1)
QX(14,J,K)=QX(12,J,K)+QX(11,J,K)
QX(33,J,K)=ARDEM(2)*0.45
QX(34,J,K)=QX(15,J,K)+QX(33,J,K)
CALL ARSUB(2)
QX(22,J,K)=QX(19,J,K)+QX(20,J,K)
CALL MUNSUB(2)
QX(27,J,K)=QX(25,J,K)+QX(24,J,K)
QX(31,J,K)=QX(14,J,K)+QX(27,J,K)
QX(28,J,K)=QX(31,J,K)-QX(32,J,K)
CALL WETLND(1)
QX(30,J,K)=QX(28,J,K)-QX(29,J,K)
QX(37,J,K)=QX(30,J,K)*.9
QX(38,J,K)=QX(30,J,K)-QX(37,J,K)
RETURN
END
