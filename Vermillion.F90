...
!     Last change: SOU 10/11/2013 4:33:00 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
DEM12=WETDMD(1)
DEM13=DMDMD(1)
QX(1,J,K)=QX(10,J,K)+DEM13-QX(4,J,K)
QX(2,J,K)=QX(4,J,K)+DEM12
CALL WETLND(1)
QX(5,J,K)=QX(1,J,K)+QX(4,J,K)
CALL MUNSUB(1)
DIFF=QX(10,J,K)-QX(9,J,K)-QX(8,J,K)
IF (ABS(DIFF).GT.0.1) THEN
  QX(8,J,K)=QX(8,J,K)+DIFF
  QX(5,J,K)=QX(5,J,K)+DIFF
  QX(1,J,K)=QX(1,J,K)+DIFF
END IF
CALL ARSUB(1)
QX(17,J,K)=QX(16,J,K)+QX(14,J,K)
QX(19,J,K)=QX(17,J,K)+QX(18,J,K)
!Calculate additional inflow from Colorado as reach gain for Green River
QX(22,J,K)=QX(1,J,K)-QX(20,J,K)-QX(21,J,K)
RETURN
END
