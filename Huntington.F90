...
!     Last change: CWM 6/29/2012 10:52:25 AM
!     ******************************************************************
...
REAL (KIND=8) :: PRICE(12),HUNTCOTT(12),CANAL(12)
DATA PRICE/1906.,1845.,1906.,1906.,1737.,1906.,1845.,2460.,2916., &
  3259.,2705.,2380./
DATA HUNTCOTT/1353.,1309.,1353.,1353.,1233.,1353.,1309.,1722., &
  2023.,2275.,1906.,1666./
DATA CANAL/1230.,0.,0.,0.,0.,0.,357.,2644.,6486.,2951.,615.,179./
!-----------------------------------------------------------------------
!     CODE FOR HUNTINGTON WATER BUDGET MODEL
!-----------------------------------------------------------------------
QX(1,J,K)=RSBAK(1)
!CALL REINI(1)
QX(4,J,K)=QX(2,J,K)-QX(3,J,K)
CALL MUNSUB(1)
QX(9,J,K)=QX(7,J,K)+QX(6,J,K)
CALL WETLND(1)
QX(12,J,K)=QX(13,J,K)-QX(11,J,K)
RETURN
END
