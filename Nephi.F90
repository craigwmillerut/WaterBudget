...
!     Last change: CWM 8/6/2012 9:36:05 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
REAL (KIND=8) :: DIFF,DIFFBEF,Balance
INTEGER (KIND=4) :: JJJ
!-----------------------------------------------------------------------
!     CODE FOR Nephi Water Budget Model
!-----------------------------------------------------------------------
CALL MUNSUB(1)
QX(18,J,K)=QX(4,J,K)+QX(3,J,K)
QX(15,J,K)=QX(6,J,K)-QX(18,J,K)+ARDEM(1)
QX(6,J,K)=QX(18,J,K)+QX(15,J,K)
CALL ARSUB(1)
QX(21,J,K)=.50*QX(11,J,K)
QX(22,J,K)=.50*QX(11,J,K)
QX(8,J,K)=QX(6,J,K)-QX(7,J,K)
QX(17,J,K)=QX(10,J,K)+QX(11,J,K)
CALL WETLND(1)
QX(13,J,K)=QX(17,J,K)-QX(16,J,K)
DIFF=QIN(2,J,K)-QX(13,J,K)
DIFFBEF=1.E9
IF (ABS(DIFF).GT.0.1)THEN
  DO
    CALL ARBAK(1)
    Balance=QX(24,J,K)+QX(15,J,K)
    Balance=Balance+DIFF
    QX(15,J,K)=MAX(0.0,Balance)
    QX(24,J,K)=Balance-QX(15,J,K)
    QX(10,J,K)=0.0
    QX(8,J,K)=0.0
    QX(6,J,K)=QX(18,J,K)+QX(15,J,K)
    CALL ARSUB(1)
    QX(21,J,K)=QX(11,J,K)*.50
    QX(22,J,K)=QX(11,J,K)*.50
    QX(17,J,K)=QX(10,J,K)+QX(21,J,K)
    CALL WETLND(1)
    QX(13,J,K)=QX(17,J,K)-QX(16,J,K)+QX(24,J,K)
    DIFFBEF=DIFF
    DIFF=QIN(2,J,K)-QX(13,J,K)
...
END IF
!QX(23,J,K)=RSBAK(1)
IF (J.EQ.1.AND.K.EQ.10) THEN
  JJJ=1
END IF
CALL REINI(1)
IF (ABS(QX(14,J,K)-QIN(3,J,K)).GT.0.1) THEN
  QX(23,J,K)=QIN(3,J,K)-QX(14,J,K)
  QX(14,J,K)=QX(14,J,K)+QX(23,J,K)
END IF
RETURN
END
