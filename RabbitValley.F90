...
!     Last change: CWM 7/30/2012 3:23:09 PM
!     ******************************************************************
...
REAL (KIND=8):: UpperPro,AddedFlow,DIFF,DIFFBEF
DATA UpperPro/.8/
!-----------------------------------------------------------------------
!     SAMPLE CODE FOR GENERAL MODEL
!-----------------------------------------------------------------------
AddedFlow=QX(19,J,K)-QX(16,J,K)-QX(1,J,K)+AGDEM(1)+DMDMD(1)+WETDMD(1)
QX(20,J,K)=AddedFlow*UpperPro
QX(21,J,K)=QX(20,J,K)+QX(1,J,K)
CALL ARSUB(1)
...
QX(18,J,K)=(1.0-UpperPro)*AddedFlow
...
IF (ABS(DIFF).GT.0.1) THEN
  DO
    ...
    QX(5,J,K)=0.0
    QX(10,J,K)=0.0
    QX(20,J,K)=DIFF*UpperPro+QX(20,J,K)
    QX(21,J,K)=QX(20,J,K)+QX(1,J,K)
    CALL ARSUB(1)
    QX(8,J,K)=QX(5,J,K)+QX(6,J,K)
    CALL MUNSUB(1)
    ...
    CALL WETLND(1)
    QX(17,J,K)=QX(16,J,K)+QX(15,J,K)
    QX(18,J,K)=QX(18,J,K)+(1.0-UpperPro)*DIFF
    DIFFBEF=DIFF
    DIFF=QX(19,J,K)-QX(17,J,K)-QX(18,J,K)
    IF (ABS(DIFF).LE.0.1.OR.ABS(DIFF-DIFFBEF).LE.0.1) THEN
      EXIT
    END IF
  END DO
END IF
