...
!     Last change: CWM 8/16/2012 8:19:12 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
QX(20,J,K)=QX(15,J,K)+QX(16,J,K)
DIFF=QX(17,J,K)-QX(20,J,K)
IF (ABS(DIFF).GT.0.1) THEN
  DO
    Balance=QX(18,J,K)+QX(21,J,K)
    Balance=Balance+DIFF
    QX(18,J,K)=MAX(0.0,Balance)
    QX(21,J,K)=MIN(0.0,Balance)
    QX(19,J,K)=QX(1,J,K)+QX(18,J,K)
    CALL ARBAK(1)
    QX(3,J,K)=0.0
    QX(5,J,K)=0.0
    CALL ARSUB(1)
    ...
    QX(15,J,K)=QX(13,J,K)-QX(14,J,K)
    QX(20,J,K)=QX(15,J,K)+QX(16,J,K)
    DIFF=QX(17,J,K)-QX(20,J,K)-QX(21,J,K)
