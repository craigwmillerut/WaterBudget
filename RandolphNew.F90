...
!     Last change: SOU 2/18/2015 2:27:57 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
REAL (KIND=8) :: DIFF,DIFFBEF,BEARMIN,UNGAUGED
DATA BEARMIN/2000./
INTEGER (KIND=4) :: JJJ
!-----------------------------------------------------------------------
!     SAMPLE CODE FOR GENERAL MODEL
!-----------------------------------------------------------------------
!Set ungauged flows to zero
QX(4,J,K)=0.0
QX(27,J,K)=0.0
QX(39,J,K)=0.0

!The flow into Neponset Reservoir is calculated
QX(38,J,K)=RSBAK(1)

!Land area 1 below Neponset
QX(5,J,K)=QX(4,J,K)+QX(3,J,K)
CALL ARSUB(1)
QX(12,J,K)=QX(9,J,K)+QX(11,J,K)

!Calculate flow into Woodruff Creek Reservoir
IF(J.EQ.1.AND.K.EQ.12) THEN
  JJJ=1
ENDIF
QX(13,J,K)=0.0
QX(13,J,K)=RSBAK(3)
!Initialize Birch Creek Reservoir
CALL REINI(2)

!Calculate the combined flow below Woodruff Creek and Birch Creek Reservoirs
QX(17,J,K)=QX(14,J,K)+QX(16,J,K)
!Flow into Bear River from tributaries
QX(18,J,K)=QX(17,J,K)+QX(12,J,K)
!Bear River mainstem flows
QX(19,J,K)=QX(18,J,K)+QX(1,J,K)
QX(21,J,K)=QX(19,J,K)+QX(20,J,K)
CALL MUNSUB(1)
QX(26,J,K)=QX(25,J,K)+QX(23,J,K)
!Add in ungauged flow if available
QX(28,J,K)=QX(27,J,K)+QX(26,J,K)
CALL ARSUB(2)
QX(30,J,K)=QX(28,J,K)-QX(29,J,K)
QX(35,J,K)=QX(32,J,K)+QX(34,J,K)
CALL WETLND(1)
QX(37,J,K)=QX(35,J,K)-QX(36,J,K)
QX(40,J,K)=QX(37,J,K)+QX(39,J,K)
DIFF = QIN(5,J,K)-QX(37,J,K)
DIFFBEF = DIFF
if (K.EQ.10.AND.J.EQ.18) then
  JJJ=1
end if
IF (ABS(DIFF) .gt. 0.3) THEN
    DO
      ...
      QX(30,J,K)= 0.0
      QX(36,J,K)= 0.0
      UNGAUGED=QX(27,J,K)+QX(39,J,K)+DIFF
      QX(27,J,K)=MAX(0.0,UNGAUGED)
      QX(39,J,K)=MIN(0.0,UNGAUGED)
      !QX(27,J,K)=MAX(MIN(0.0,-QX(26,J,K)+BEARMIN), QX(27,J,K)+DIFF)
      QX(28,J,K)=QX(27,J,K)+QX(26,J,K)
      CALL ARSUB(2)
      QX(35,J,K)=QX(32,J,K)+QX(34,J,K)
      CALL WETLND(1)
      QX(37,J,K)=QX(35,J,K)-QX(36,J,K)
      DIFF = QIN(5,J,K)-QX(37,J,K)-QX(39,J,K)
      !IF (ABS(Diff) .LT. 0.1 .OR. ABS(DIFF-DIFFBEF).LT.0.1) Exit
      IF (ABS(Diff) .LT. 0.1) Exit
      DIFFBEF = DIFF
    END DO
END IF
QX(40,J,K)=QX(37,J,K)+QX(39,J,K)
