...
!     Last change: SOU 4/13/2015 9:47:57 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
!Reach gain for Diamond Fork.  QX1 is strawberry tunnel
!QX3 AND QIN1 ARE THE DIAMOND FORK GAUGES
IF (IYEAR(J).GT.2001) THEN
  QX(2,J,K)=QX(3,J,K)-QX(1,J,K)-QX(18,J,K)
ELSE
  QX(2,J,K)=QIN(1,J,K)-QX(1,J,K)-QX(18,J,K)
  QX(3,J,K)=QIN(1,J,K)
END IF
!Municipal is a campground and private domestic
CALL MUNSUB(1)
QX(16,J,K)=QX(5,J,K)+QX(7,J,K)
!Small amounts of agriculture
CALL ARSUB(1)
QX(12,J,K)=QX(10,J,K)+QX(11,J,K)
!Some riparian demand
QX(14,J,K)=QX(6,J,K)-QX(5,J,K)
CALL MUNSUB(1)
QX(11,J,K)=QX(9,J,K)+QX(8,J,K)
CALL WETLND(1)
