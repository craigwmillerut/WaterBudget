...
!     Last change: SOU 2/5/2014 10:40:49 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!All of this code needs to be reprogrammed SM

CALL MUNSUB(1)
QX(37,J,K)=QX(12,J,K)+QX(11,J,K)
QX(15,J,K)=QX(37,J,K)+QX(14,J,K)
QX(17,J,K)=QX(15,J,K)+QX(16,J,K)
CALL ARSUB(1)
QX(33,J,K)=QX(31,J,K)+QX(32,J,K)
QX(39,J,K)=ARDEM(2)*0.55
QX(38,J,K)=QX(39,J,K)+QX(23,J,K)
CALL ARSUB(2)
QX(30,J,K)=QX(27,J,K)+QX(28,J,K)
QX(31,J,K)=QX(30,J,K)+QX(31,J,K)
CALL ARSUB(3)
QX(8,J,K)=QX(5,J,K)+QX(6,J,K)
CALL WETLND(1)
QX(35,J,K)=QX(33,J,K)-QX(34,J,K)
QX(36,J,K)=QX(35,J,K)+QX(8,J,K)
RETURN
END
