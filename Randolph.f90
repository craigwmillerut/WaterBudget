...
!     Last change: CWM 9/12/2012 2:52:06 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
CALL REINI(1)
Diff = QIN(2,J,K)-QX(18,J,K)
IF (ABS(Diff).GT.0.1) THEN
  QX(18,J,K)=QX(18,J,K)+Diff
  IF (STO(1).LT.SMN(1)) THEN
    QX(38,J,K)=SMN(1)-STO(1)+Diff
    STO(1)=SMN(1)
  ELSE
    QX(38,J,K)=Diff
  END IF
