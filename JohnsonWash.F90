...
!     Last change: CWM 7/6/2011 4:28:36 PM
!     ******************************************************************
...
use COMMO
use PrintStuff
REAL (KIND=8) :: DIFF,DIFBEF
INTEGER (KIND=4) :: JJ
REAL (KIND=8),EXTERNAL :: ARDEM,DMDMD,WETDMD
!-----------------------------------------------------------------------
!     CODE FOR JOHNSON WASH MODEL
!-----------------------------------------------------------------------
QX(1,J,K)=QIN(1,J,K)+ARDEM(1)
DIFF=1.0E6
IF(J.EQ.1.AND.K.EQ.9)THEN
  JJ=1
ENDIF
DO
  QX(3,J,K)=0.0
  ...
  DIFBEF=DIFF
  DIFF=QIN(1,J,K)-QX(8,J,K)
  IF (ABS(DIFBEF-DIFF).LE..0001) THEN
    EXIT
  END IF
...
END DO
CALL MUNSUB(1)
QX(11,J,K)=QX(8,J,K)+QX(10,J,K)
CALL WETLND(1)
QX(13,J,K)=QX(11,J,K)-QX(12,J,K)
CALL ARSUB(2)
QX(20,J,K)=QX(17,J,K)+QX(19,J,K)
CALL MUNSUB(2)
QX(23,J,K)=QX(20,J,K)+QX(22,J,K)
RETURN
END
