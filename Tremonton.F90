...
!     Last change: SOU 5/14/2015 12:44:04 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
!Portage area municipal
QX(6,J,K)=DMDMD(1)
QX(1,J,K)=QX(6,J,K)
CALL MUNSUB(1)
!Portage area agriculture
QX(7,J,K)=ARDEM(1)
QX(1,J,K)=QX(1,J,K)+QX(7,J,K)
QX(10,J,K)=QX(5,J,K)+QX(9,J,K)
CALL ARSUB(1)
QX(11,J,K)=QX(10,J,K)-QX(3,J,K)
QX(13,J,K)=QX(11,J,K)+QX(4,J,K)
!West Side Canal
CALL ARSUB(2)
!Riparian
CALL WETLND(1)
QX(31,J,K)=QX(19,J,K)-QX(30,J,K)
!Tremonton area municipal
CALL MUNSUB(2)
!Tremonton area agriculture
CALL ARSUB(3)
QX(37,J,K)=QX(25,J,K)+QX(26,J,K)
!Bear river below return flow from ag and municipal
QX(32,J,K)=QX(37,J,K)+QX(27,J,K)
!Malad River
QX(31,J,K)=QX(20,J,K)+QX(21,J,K)
QX(29,J,K)=QX(21,J,K)+QX(20,J,K)
!Below confluence of Malad and Bear River
QX(34,J,K)=QX(29,J,K)+QX(32,J,K)
!Balance flow
QX(33,J,K)=QX(35,J,K)-QX(34,J,K)
RETURN
END
