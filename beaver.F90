...
!     Last change: SOU 10/18/2013 3:22:00 PM
!     ******************************************************************
...
!              land area number.
!     DMPMP -  Function returning the total domestic pump demand for
!              area.  Use as follows DEM=DMPMP(L), where L is the land
!              area number.
...
INTEGER (KIND=4) :: MM,JJ
!-----------------------------------------------------------------------
!     CODE FOR BEAVER WATER BUDGET
!-----------------------------------------------------------------------
QX(6,J,K)=QX(1,J,K)+QX(2,J,K)+QX(3,J,K)+QX(4,J,K)+QX(5,J,K)
!Determine the demand from Ag Area 2 (Manderfield supplied by Beaver)
QX(21,J,K)=MIN(ARDEM(2),QX(6,J,K))
!Calculate depletion from Manderfield supplied by Beaver
CALL ARSUB(2)
QX(6,J,K)=QX(6,J,K)-QX(21,J,K)
!Calculate municipal demand from Beaver
CALL MUNSUB(1)
QX(11,J,K)=QX(8,J,K)+QX(9,J,K)
!Calculate agricultural demand from Beaver
CALL ARSUB(1)
QX(18,J,K)=QX(15,J,K)+QX(16,J,K)
CALL WETLND(1)
QX(20,J,K)=QX(18,J,K)-QX(19,J,K)
QX(26,J,K)=QX(24,J,K)+QX(25,J,K)
CALL MUNSUB(2)
QX(31,J,K)=QX(28,J,K)+QX(29,J,K)
CALL ARSUB(3)
QX(38,J,K)=QX(35,J,K)+QX(36,J,K)
CALL WETLND(2)
QX(40,J,K)=QX(38,J,K)-QX(39,J,K)
QX(41,J,K)=QX(40,J,K)+QX(23,J,K)+QX(20,J,K)
QX(42,J,K)=QIN(6,J,K)+QX(44,J,K)-QX(41,J,K)
QX(43,J,K)=QX(42,J,K)+QX(41,J,K)
RETURN
END
