...
!     Last change: SOU 3/26/2015 10:57:17 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
!Georgetown municipal demand
CALL MUNSUB(1)
QX(7,J,K)=QX(4,J,K)+QX(6,J,K)
!Georgetown Creek agricultural demand
CALL ARSUB(1)
QX(14,J,K)=QX(11,J,K)+QX(13,J,K)
!Georgetown Creek confluence with Bear
QX(15,J,K)=QX(1,J,K)+QX(14,J,K)
!Stauffer Creek confluence with Bear
QX(17,J,K)=QX(15,J,K)+QX(16,J,K)
!Mainstem Bear River ag land demand
CALL ARSUB(2)
QX(24,J,K)=QX(21,J,K)+QX(23,J,K)
!Soda Springs muncipal demand
CALL MUNSUB(2)
QX(29,J,K)=QX(26,J,K)+QX(28,J,K)
CALL WETLND(1)
QX(31,J,K)=QX(29,J,K)-QX(30,J,K)
!Snake Creek area demand
QX(33,J,K)=ARDEM(3)
QX(35,J,K)=0.0
!Get the balance flow into Alexander Reservoir
QX(35,J,K)=RSBAK(1)
!QX34 is what makes up the difference on Soda Point
QX(34,J,K)=QX(35,J,K)-QX(31,J,K)
!QX32 is the ungauged flow
QX(32,J,K)=QX(34,J,K)+QX(33,J,K)
CALL ARSUB(3)
RETURN
END
