...
!     Last change: SOU 4/26/2015 6:47:44 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
INTEGER (KIND=4) :: II(4),NI,JJJ
DATA II/88,86,34,33/NI/4/
!-----------------------------------------------------------------------
!     SAMPLE CODE FOR GENERAL MODEL
!-----------------------------------------------------------------------
QX(5,J,K)=QX(1,J,K)+QX(2,J,K)
!Idaho municipal deliveries
CALL MUNSUB(1)
QX(10,J,K)=QX(7,J,K)+QX(9,J,K)
!West Cache Canal
QX(12,J,K)=QX(10,J,K)-QX(11,J,K)+qx(72,J,K)
!Idaho Ag Demands
CALL ARSUB(1)
QX(14,J,K)=QX(22,J,K)+QX(23,J,K)
!Balance flow for Bear River near Border
QX(13,J,K)=QX(24,J,K)-QX(14,J,K)
!Ungauged flows added for Ag lands above Bear River @ Smithfield
QX(74,J,K)=QX(26,J,K)+QX(67,J,K)+QX(68,J,K)+QX(69,J,K)+QX(70,J,K)+ &
  QX(71,J,K)
!Bear River with ungauged flows upstream of Ag demands
QX(75,J,K)=QX(74,J,K)+QX(24,J,K)
!Ag demand above Bear River near Smithfield
CALL ARSUB(3)
!Balance flow for Bear River near Smithfield, 101022500
QX(84,J,K)=QX(27,J,K)-QX(79,J,K)-QX(80,J,K)
!Set inflow to Newton to zero
QX(28,J,K)=0.0
!Newton Reservoir
QX(28,J,K)=RSBAK(1)
!Include one other ungauged flow into Bear River plus Newton
QX(30,J,K)=QX(27,J,K)+QX(29,J,K)+QX(91,J,K)
...
CALL REINI(2)
!Add ungauged flows above Hyrum before demands for Ag Area 4
QX(34,J,K)=QX(31,J,K)+QX(33,J,K)+QX(82,J,K)+QX(83,J,K)+QX(92,J,K)
!Ag lands above Hyrum Reservoir
CALL ARSUB(4)
QX(35,J,K)=0.0
DMD=MAX(0.0,QX(36,J,K)-QX(88,J,K)-QX(89,J,K))
!Call on Prcupine to match QX36, Little Bear River at Paradise
IF (DMD.GT.0.0) THEN
  CALL RESR(2,II,NI)
END IF
!Balance flow for Little Bear River above Hyrum
QX(35,J,K)=QX(36,J,K)-QX(88,J,K)-QX(89,J,K)
!Calculate balance flow into Hyrum Reservoir
QX(25,J,K)=0.0
QX(25,J,K)=DMD-QDVM
QX(37,J,K)=0.0
!Balance flow into Hyrum
QX(25,J,K)=0.0
QX(25,J,K)=RSBAK(3)
!Combined flow of Logan, Blacksmith Fork and
!ungauged Providence Canyon
QX(40,J,K)=QX(38,J,K)+QX(39,J,K)+QX(73,J,K)
!Confluence of Little Bear and Logan
QX(41,J,K)=QX(37,J,K)+QX(40,J,K)
QX(45,J,K)=QX(41,J,K)+QX(42,J,K)

!Main stem Bear
!Finally, Confluence with Bear River
QX(46,J,K)=QX(30,J,K)+QX(45,J,K)
!Municipal demand Utah
CALL MUNSUB(2)
QX(51,J,K)=QX(48,J,K)+QX(50,J,K)
!Utah Agricultural demand
CALL ARSUB(2)
QX(58,J,K)=QX(55,J,K)+QX(57,J,K)
!Riparian demand
CALL WETLND(1)
QX(60,J,K)=QX(58,J,K)-QX(59,J,K)
QX(63,J,K)=QX(60,J,K)-QX(61,J,K)-QX(62,J,K)
QX(65,J,K)=0.0
!Balance flow into Cutler
QX(65,J,K)=RSBAK(4)
RETURN
END
