...
!     Last change: CWM 10/4/2012 10:21:50 AM
!     ******************************************************************
...
REAL (KIND=8) :: Balance,Diff
!-----------------------------------------------------------------------
!     SAMPLE CODE FOR GENERAL MODEL
!-----------------------------------------------------------------------
QX(3,J,K)=QX(2,J,K)
CALL REINI(1)
QX(5,J,K)=QX(3,J,K)+QX(4,J,K)+QX(24,J,K)
CALL MUNSUB(1)
QX(9,J,K)=QX(7,J,K)+QX(8,J,K)
CALL ARSUB(1)
QX(22,J,K)=QX(13,J,K)+QX(14,J,K)+QX(25,J,K)
CALL WETLND(1)
QX(16,J,K)=QX(22,J,K)-QX(21,J,K)
Diff=QIN(4,J,K)-QX(16,J,K)
DO WHILE (ABS(Diff).GT.0.1)
  Balance=QX(24,J,K)+QX(25,J,K)+DIFF
