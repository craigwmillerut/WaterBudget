...
!     Last change: SOU 4/4/2014 12:31:13 PM
!     ******************************************************************
...
INTEGER (KIND=4) :: JJ
!-----------------------------------------------------------------------
!     CODE FOR Escalante Desert 06-03-01, Model 12
!-----------------------------------------------------------------------
QX(14,J,K)=0.0
QX(9,J,K)=0.0
QX(15,J,K)=QX(14,J,K)
...
CALL REINI(3)
CALL REINI(4)
IF(DMDMD(1).GT.0.0.AND.QX(15,J,K).GT.0.0)THEN
  !This makes sure that the municipal demand bypasses the ag lands
  Edmd=MAX(0.0,MIN(QX(15,J,K),DMDMD(1)))
  QX(17,J,K)=Edmd
  QX(19,J,K)=Edmd
  QX(24,J,K)=Edmd
END IF
...
QX(24,J,K)=QX(20,J,K)+QX(19,J,K)
CALL MUNSUB(1)
QX(29,J,K)=QX(24,J,K)-QX(25,J,K)
QX(30,J,K)=QX(29,J,K)+QX(27,J,K)
CALL WETLND(1)
QX(22,J,K)=QX(30,J,K)-QX(23,J,K)
!QX(31,J,K)=-QX(22,J,K)
QX(31,J,K)=0.0
QX(32,J,K)=QX(22,J,K)
RETURN
