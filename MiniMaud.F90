...
!     Last change: CWM 8/9/2012 8:02:19 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
CALL MUNSUB(1)
QX(4,J,K)=QX(1,J,K)+QX(3,J,K)+QX(11,J,K)
CALL ARSUB(1)
QX(10,J,K)=QX(8,J,K)+QX(9,J,K)
CALL WETLND(1)
DIFF=QX(14,J,K)-QX(10,J,K)+QX(13,J,K)
IF (ABS(DIFF).GT.0.1) THEN
  DO
    CALL ARBAK(1)
    QX(6,J,K)=0.0
    QX(8,J,K)=0.0
    Balance=QX(11,J,K)+QX(18,J,K)+Diff
    QX(11,J,K)=MAX(Balance,0.0)
    QX(18,J,K)=Balance-QX(11,J,K)
    QX(4,J,K)=QX(1,J,K)+QX(3,J,K)+QX(11,J,K)
    CALL ARSUB(1)
    QX(10,J,K)=QX(8,J,K)+QX(9,J,K)
    CALL WETLND(1)
    DIFF=QX(14,J,K)-QX(10,J,K)+QX(13,J,K)-QX(18,J,K)
    IF (ABS(DIFF).LE.0.1) THEN
      EXIT
    END IF
  END DO
END IF
QX(20,J,K)=QX(14,J,K)+QX(15,J,K)
CALL ARSUB(2)
QX(16,J,K)=QX(24,J,K)+QX(25,J,K)
RETURN
END
