...
!     Last change: SOU 3/13/2015 4:04:02 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!Logan and Little Bear River areas
QX(43,J,K)=0.0
CALL REINI(1)
CALL REINI(2)
QX(34,J,K)=QX(33,J,K)+QX(31,J,K)
QX(35,J,K)=QX(36,J,K)-QX(34,J,K)
CALL REINI(3)
QX(40,J,K)=QX(38,J,K)+QX(39,J,K)
QX(41,J,K)=QX(37,J,K)+QX(40,J,K)
QX(44,J,K)=QX(43,J,K)+QX(42,J,K)
!Logan river above confluence
QX(45,J,K)=QX(41,J,K)+QX(44,J,K)

!Bear River in Idaho
QX(5,J,K)=QX(1,J,K)+QX(2,J,K)
!Idaho municipal water use
CALL MUNSUB(1)
QX(10,J,K)=QX(7,J,K)+QX(9,J,K)
!Divert West Cache Canal from Bear River
QX(12,J,K)=QX(10,J,K)-QX(11,J,K)
!Idaho irrigated lands
CALL ARSUB(1)
QX(14,J,K)=QX(22,J,K)+QX(23,J,K)
!Balance flow above Bear River at Border
QX(13,J,K)=QX(24,J,K)-QX(14,J,K)
!Flow below Bear River at Border
QX(27,J,K)=QX(24,J,K)+QX(26,J,K)
!Flow below Newton
QX(30,J,K)=QX(27,J,K)+QX(29,J,K)
!Below confluence with Logan River
QX(46,J,K)=QX(30,J,K)+QX(45,J,K)

!Utah municipal demand
CALL MUNSUB(2)
...
!Calculate Inflow to Cutler
QX(63,J,K)=0.0
QX(63,J,K)=RSBAK(4)
QX(65,J,K)=QX(63,J,K)+QX(61,J,K)-QX(60,J,K)
RETURN
END
