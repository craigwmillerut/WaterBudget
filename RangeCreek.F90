...
!     Last change: CWM 8/14/2012 9:33:55 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
use COMMO
use PrintStuff
REAL (KIND=8),EXTERNAL :: ARDEM,DMDMD,WETDMD,RSBAK,RSOUT,MUNBAK
REAL (KIND=8)::DIFF
!-----------------------------------------------------------------------
!     SAMPLE CODE FOR GENERAL MODEL
!-----------------------------------------------------------------------
QX(1,J,K)=DMDMD(1)+WETDMD(1)+ARDEM(1)
CALL MUNSUB(1)
QX(6,J,K)=QX(5,J,K)+QX(3,J,K)
CALL ARSUB(1)
QX(12,J,K)=QX(11,J,K)+QX(10,J,K)
CALL WETLND(1)
DIFF=QIN(1,J,K)-QX(12,J,K)+QX(13,J,K)
