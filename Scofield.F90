...
!     Last change: SOU 9/5/2013 10:05:13 AM
!     ******************************************************************
...
use COMMO
use PrintStuff
REAL (KIND=8),EXTERNAL :: ARDEM,DMDMD,RSBAK
REAL (KIND=8) :: DIFF,Balance
!-----------------------------------------------------------------------
!     CODE FOR SCOFIELD 08-01-01
!-----------------------------------------------------------------------
!Calculate flows before Fairview Tunnel exports
QX(1,J,K)=QX(3,J,K)+QX(2,J,K)
!Calculate Price River balancing flows
QX(4,J,K)=QX(5,J,K)-QX(3,J,K)
QX(29,J,K)=QX(8,J,K)+QX(24,J,K)
CALL ARSUB(1)
DIFF=QX(14,J,K)-QX(13,J,K)-QX(12,J,K)
IF (ABS(DIFF).GT.0.1) THEN
  do  
    Balance=QX(24,J,K)+QX(30,J,K)+DIFF
    CALL ARBAK(1)
    QX(10,J,K)=0.0
    QX(12,J,K)=0.0
    QX(24,J,K)=MAX(0.0,Balance)
    QX(30,J,K)=Balance-QX(24,J,K)
    QX(29,J,K)=QX(24,J,K)+QX(8,J,K)
    CALL ARSUB(1)
    DIFF=QX(14,J,K)-QX(13,J,K)-QX(12,J,K)-QX(30,J,K)
...
!-----------------------------------------------------------------------
!Calculate the balancing flow into Scofield Reservoir
!Most inflows are gauged
!Outflows are gauged
!Storage is gauged
!-----------------------------------------------------------------------
QX(25,J,K)=RSBAK(1)
...
!Calculate subarea balancing flow
!QX23 (subarea outflow) is gauged, 09311700, Price River near Soldier Summit
QX(26,J,K)=QX(23,J,K)-QX(21,J,K)
RETURN
END
