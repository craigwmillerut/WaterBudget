...
!     Last change: SOU 5/9/2012 6:40:05 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
REAL (KIND=8)::DEM13, DIFF,INFLO
!-----------------------------------------------------------------------
!     SAMPLE CODE FOR GENERAL MODEL
!-----------------------------------------------------------------------
!DEM13=DMDMD(1)
!QX(2,J,K)=QX(8,J,K)-QX(1,J,K)+DEM13
QX(1,J,K)=0.84*QX(8,J,K)
QX(2,J,K)=0.16*QX(8,J,K)
CALL MUNSUB(1)
QX(4,J,K)=QX(2,J,K)-QX(3,J,K)
QX(7,J,K)=QX(6,J,K)+QX(4,J,K)
DIFF=QX(8,J,K)-QX(1,J,K)-QX(7,J,K)
