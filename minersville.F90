...
!     Last change: CWM 5/5/2011 7:45:57 AM
!     ******************************************************************
...
!-----------------------------------------------------------------------
QX(6,J,K)=QX(1,J,K)+QX(2,J,K)+QX(3,J,K)+QX(4,J,K)+QX(10,J,K)
IF (K.EQ.4) THEN
  MM=1
END IF
QX(5,J,K)=MIN(ARDEM(2),QX(6,J,K))
CALL ARSUB(2)
QX(6,J,K)=QX(6,J,K)-QX(5,J,K)
CALL MUNSUB(1)
QX(12,J,K)=QX(8,J,K)+QX(9,J,K)
CALL ARSUB(1)
QX(16,J,K)=QX(14,J,K)-QX(15,J,K)
QX(19,J,K)=QX(18,J,K)+QX(16,J,K)
CALL WETLND(1)
QX(22,J,K)=QX(26,J,K)-QX(21,J,K)
RETURN
END
