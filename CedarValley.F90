...
!     Last change: CWM 8/28/2012 6:44:44 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
REAL (KIND=8) :: MagicFactor,BigSpring(12)
DATA MagicFactor/1.5/BigSpring/4*221,219,7*221/
REAL (KIND=8) :: AddedGW(13)
DATA AddedGW/8*667.0,4*666.0,8000.0/
!-----------------------------------------------------------------------
!     SAMPLE CODE FOR GENERAL MODEL
!-----------------------------------------------------------------------
QX(7,J,K)=QX(7,J,K)*MagicFactor
QX(16,J,K)=BigSpring(K)
CALL ARSUB(1)
