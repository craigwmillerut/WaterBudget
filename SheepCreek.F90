...
!     Last change: SOU 5/3/2012 6:26:29 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
REAL (KIND=8)::DEM12,DEM13, DIFF,DIFFBEF
!-----------------------------------------------------------------------
!     SAMPLE CODE FOR GENERAL MODEL
!-----------------------------------------------------------------------
DEM12=WETDMD(1)
DEM13=DMDEM(1)
QX(12,J,K)=QX(20,J,K)+QX(19,J,K)+QX(13,J,K)+DEM12
QX(14,J,K)=QX(12,J,K)-QX(13,J,K)
CALL WETLND(1)
QX(16,J,K)=QX(14,J,K)-QX(15,J,K)
QX(1,J,K)=QX(25,J,K)+QX(22,J,K)-QX(13,J,K)+QX(6,J,K)-DEM13
CALL MUNSUB(1)
QX(5,J,K)=QX(4,J,K)+QX(3,J,K)
QX(11,J,K)=QX(5,J,K)-QX(6,J,K)
QX(21,J,K)=QX(11,J,K)+QX(13,J,K)
CALL REINI(1)
CALL ARSUB(1)
QX(27,J,K)=QX(24,J,K)+QX(25,J,K)
!Balance Flow
QX(26,J,K)=QX(28,J,K)-QX(27,J,K)
RETURN
END
