...
!     Last change: SOU 4/23/2012 3:17:46 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
REAL (KIND=8)::DEM12, DEM13,REM
!-----------------------------------------------------------------------
!     SAMPLE CODE FOR GENERAL MODEL
!-----------------------------------------------------------------------
DEM12=DMDEM(1)
QX(16,J,K)=QX(18,J,K)+DEM12
CALL MUNSUB(1)
QX(10,J,K)=QX(9,J,K)+QX(8,J,K)
QX(19,J,K)=QX(18,J,K)+QX(14,J,K)
DEM13=ARDEM(1)
REM=QX(5,J,K)-DEM13
QX(1,J,K)=QX(3,J,K)+REM
CALL ARSUB(1)
QX(11,J,K)=QX(9,J,K)+QX(10,J,K)
QX(12,J,K)=QX(11,J,K)+QX(4,J,K)
QX(13,J,K)=QX(12,J,K)+QX(3,J,K)
QX(20,J,K)=QX(13,J,K)+QX(19,J,K)
QX(23,J,K)=QX(21,J,K)/3
CALL ARSUB(2)
QX(29,J,K)=QX(28,J,K)+QX(27,J,K)
QX(31,J,K)=QX(29,J,K)+QX(30,J,K)
QX(34,J,K)=QX(20,J,K)+QX(31,J,K)
CALL WETLND(1)
