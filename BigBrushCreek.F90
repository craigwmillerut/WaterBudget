...
!     Last change: SOU 5/15/2012 11:01:43 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!Brush Creek
CALL MUNSUB(3)
QX(23,J,K)=QX(22,J,K)+QX(20,J,K)

!BIG Brush Creek
QX(3,J,K)=DMDMD(1)+DMDMD(2)+QX(14,J,K)+QX(15,J,K)
QX(1,J,K)=QX(2,J,K)+QX(3,J,K)
CALL MUNSUB(1)
QX(8,J,K)=QX(5,J,K)+QX(7,J,K)
CALL MUNSUB(2)
QX(13,J,K)=QX(10,J,K)+QX(12,J,K)

!Check with gage value and correct
DIFF=QX(14,J,K)+QX(13,J,K)-QX(15,J,K)
IF (DIFF.GT.0.1) THEN
    CALL MUNBAK(1)
    CALL MUNBAK(2)
    QX(3,J,K)=DMDMD(1)+DMDMD(2)+QX(14,J,K)+QX(15,J,K)-DIFF
    QX(1,J,K)=QX(2,J,K)+QX(3,J,K)
    CALL MUNSUB(1)
    QX(8,J,K)=QX(5,J,K)+QX(7,J,K)
    CALL MUNSUB(2)
...
!Combined flow
CALL REINI(1)
QX(36,J,K)=QX(17,J,K)-QX(16,J,K)
QX(24,J,K)=QX(17,J,K)+QX(23,J,K)
CALL ARSUB(1)
QX(30,J,K)=QX(28,J,K)+QX(29,J,K)
CALL WETLND(1)
QX(37,J,K)=QX(32,J,K)-QX(35,J,K)
QX(33,J,K)=QX(34,J,K)-QX(37,J,K)
