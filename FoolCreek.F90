...
!     Last change: SOU 3/10/2014 3:39:57 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
QX(20,J,K)=QX(1,J,K)-QX(19,J,K)
CALL ARSUB(1)
QX(8,J,K)=QX(6,J,K)+QX(5,J,K)
CALL ARSUB(2)
QX(25,J,K)=QX(23,J,K)+QX(22,J,K)
CALL MUNSUB(1)
QX(12,J,K)=QX(10,J,K)+QX(11,J,K)
CALL WETLND(1)
QX(15,J,K)=QX(16,J,K)-QX(14,J,K)
QX(18,J,K)=0.0
CALL REINI(1)
!Diff = QIN(3,J,K)-QX(17,J,K)
!IF (ABS(Diff).GT.0.1) THEN
!  QX(17,J,K)=QX(17,J,K)+Diff
!  IF (STO(1).LT.SMN(1)) THEN
!    QX(18,J,K)=SMN(1)-STO(1)+Diff
!    STO(1)=SMN(1)
!  ELSE
!   QX(18,J,K)=Diff
!  END IF
