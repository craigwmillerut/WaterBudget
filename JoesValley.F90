...
!     Last change: CWM 7/2/2012 4:39:31 PM
!     ******************************************************************
...
REAL (KIND=8) :: DIFF,DIFFBEF,COTTONWD(12)
DATA COTTONWD/36.,30.,19.5,16,17.5,32.,42.,146.,247.,85.,47.,41./
!-----------------------------------------------------------------------
!     CODE FOR JOES VALLEY WATER BUDGET
!-----------------------------------------------------------------------
QX(9,J,K)=RSBAK(1)
QX(1,J,K)=QX(9,J,K)-ARDEM(1)-QX(2,J,K)
QX(3,J,K)=QX(1,J,K)-QX(2,J,K)
CALL ARSUB(1)
DIFFBEF=1.E9
DIFF=QX(9,J,K)-QX(7,J,K)-QX(8,J,K)
...
END IF
CALL WETLND(1)
QX(16,J,K)=COTTONWD(K)
QX(14,J,K)=QX(11,J,K)-QX(13,J,K)+QX(16,J,K)
CALL MUNSUB(1)
QX(20,J,K)=QX(17,J,K)+QX(18,J,K)
QX(21,J,K)=QX(22,J,K)-QX(20,J,K)
RETURN
END
