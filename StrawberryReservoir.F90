...
!     Last change: SOU 9/24/2014 8:30:56 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
REAL (KIND=8)::RSFLOW,DEM13,DIFF,BAL,QX1MIN,QX1BEF
!-----------------------------------------------------------------------
!     SAMPLE CODE FOR GENERAL MODEL
!-----------------------------------------------------------------------
!Create outflow for Strawberry Reservoir, QIN8
QIN(8,J,K)=QIN(3,J,K)+QX(11,J,K)+QX(12,J,K)
!Calculate minimum flow for QX1
QX1MIN=DMDMD(1)+WETDMD(1)

IF (J.EQ.15.AND.K.EQ.10) THEN
  JJJ=1
END IF
QX(10,J,K)=0.0
QX(17,J,K)=0.0
!Calculate ungauged inflow to Strawberry Reservoir
RSFLOW=RSBAK(1)
QX(18,J,K)=RSFLOW
QX(1,J,K)=MAX(QX1MIN,RSFLOW-QX(9,J,K)+WETDMD(1)+DMDMD(1))
QX(17,J,K)=MIN(0.0,RSFLOW-QX1MIN-QX(9,J,K))
!QX(1,J,K)=QX(8,J,K)+DMDMD(1)+WETDMD(1)
CALL WETLND(1)
QX(3,J,K)=QX(1,J,K)-QX(2,J,K)
CALL MUNSUB(1)
QX(8,J,K)=QX(6,J,K)+QX(7,J,K)
QX(10,J,K)=QX(8,J,K)+QX(9,J,K)
DIFF=RSFLOW-QX(17,J,K)-QX(10,J,K)
IF (ABS(DIFF).GT.0.5) THEN
  QX(1,J,K)=MAX(RSFLOW-QX(9,J,K)-QX(7,J,K),QX1MIN)
  CALL WETLND(1)
  QX(3,J,K)=QX(1,J,K)-QX(2,J,K)
  QX(6,J,K)=0.0
  CALL MUNSUB(1)
  QX(8,J,K)=QX(6,J,K)+QX(7,J,K)
  QX(10,J,K)=QX(8,J,K)+QX(9,J,K)
  QX(17,J,K)=RSFLOW-QX(10,J,K)
END IF
QX(16,J,K)=QX(14,J,K)-QX(12,J,K)-QX(11,J,K)
!Balance Flow
QX(15,J,K)=QX(16,J,K)-QX(13,J,K)
RETURN
END
