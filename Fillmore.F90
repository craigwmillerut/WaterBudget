...
!     Last change: SOU 3/20/2014 11:41:31 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
!One half of Corn Creek (near Kanosh) is exported into the Cedar/Beaver
QX(3,J,K)=QIN(3,J,K)*.5
QX(4,J,K)=QX(2,J,K)+QX(3,J,K)+QX(1,J,K)
!Corn Creek Export to Cedar Beaver basin
QX(20,J,K)=.5*QIN(3,J,K)
CALL ARSUB(1)
QX(11,J,K)=QX(8,J,K)+QX(9,J,K)
CALL MUNSUB(1)
QX(16,J,K)=QX(13,J,K)+QX(14,J,K)
CALL WETLND(1)
QX(18,J,K)=QX(16,J,K)-QX(17,J,K)
!QX21 is the maximum flow that can be evaporated in the Clear Lakes region
!An internal study by Dan Aubrey shows that groundwater from Fillmore area
!feeds the Clear Lakes
QX(21,J,K)=.3*QX(18,J,K)
!QX22 is either depleted in the Fillmore area or the Delta region.  It is
!unknown which
QX(22,J,K)=QX(18,J,K)-QX(21,J,K)
RETURN
END
