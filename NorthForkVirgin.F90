...
!     Last change: SOU 11/29/2012 12:01:44 PM
!     ******************************************************************
...
INTEGER (KIND=4) :: N,JJJ
REAL (KIND=8) :: DuckCkPro(12),Diff,DiffBef
DATA DuckCkPro/0.668534754,0.851262628,0.885544618,0.712209897, &
  0.593864464,0.508108841,0.366962623,0.331051658,0.69397922, &
  0.633120773,0.750274493,0.834424128/
...
!
!Duck Creek import calculated by subtracting streamstats estimated local
!flow from long term correlated gauge 09405400.
QX(2,J,K)=QIN(1,J,K)*DuckCkPro(K)
QX(1,J,K)=QIN(1,J,K)-QX(2,J,K)
QX(3,J,K)=QIN(1,J,K)
QX(4,J,K)=QIN(3,J,K)-QIN(1,J,K)
!Calculate ungauged North Fork Virgin River inflows
DiffBef=1.E7
Diff=1.E7
DO
  ...
  QX(9,J,K)=0.0
  CALL ARSUB(2)
  QX(12,J,K)=QX(9,J,K)+QX(11,J,K)
  DIFF=QIN(3,J,K)-QX(12,J,K)
  IF (ABS(DIFF).GT..01.AND.ABS(Diff-DiffBef).GT..01) THEN
    QX(4,J,K)=MAX(0.0,QX(4,J,K)+DIFF)
    DiffBef=Diff
    CALL ARBAK(2)
  ELSE
    EXIT
...
!
!Calculate Deep Creek ungauged flow, QX12
!
QX(13,J,K)=QIN(2,J,K)-QX(12,J,K)-QX(26,J,K)
QX(14,J,K)=QX(12,J,K)+QX(13,J,K)
QX(27,J,K)=QX(14,J,K)+QX(26,J,K)
!
!Springdale/Rockville M&I demands
!
CALL MUNSUB(1)
QX(32,J,K)=QX(29,J,K)+QX(31,J,K)
!
!Add East Fork of the Virgin River (Subarea 10-01-01)
!
QX(34,J,K)=QX(32,J,K)+QX(33,J,K)
!
!Springdale AG
!
CALL ARSUB(3)
QX(41,J,K)=QX(38,J,K)+QX(40,J,K)
QX(42,J,K)=QIN(5,J,K)-QX(41,J,K)+WETDMD(1)
