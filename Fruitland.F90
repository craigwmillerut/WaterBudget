...
!     Last change: SOU 9/10/2013 8:07:56 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
QX(6,J,K)=QIN(1,J,K)-QX(7,J,K)
QX(1,J,K)=QX(6,J,K)+DMDMD(1)
CALL MUNSUB(1)
DIFF=QX(6,J,K)-QX(4,J,K)-QX(5,J,K)
...
END IF
CALL REINI(1)
QX(51,J,K)=QX(52,J,K)-QX(50,J,K)
QX(8,J,K)=QX(51,J,K)-QX(49,J,K)
QX(9,J,K)=QX(53,J,K)-QX(8,J,K)
CALL ARSUB(1)
QX(15,J,K)=QX(14,J,K)+QX(13,J,K)
!Balance Flow
QX(18,J,K)=QX(19,J,K)-QX(15,J,K)
CALL MUNSUB(3)
...
CALL REINI(2)
CALL MUNSUB(2)
QX(37,J,K)=QX(36,J,K)+QX(35,J,K)
CALL ARSUB(2)
QX(43,J,K)=QX(42,J,K)+QX(41,J,K)
!Balance Flow
QX(46,J,K)=QX(47,J,K)-QX(43,J,K)
QX(57,J,K)=QX(47,J,K)+QX(30,J,K)
CALL WETLND(1)
!Balance Flow
QX(58,J,K)=QX(48,J,K)-QX(45,J,K)
RETURN
END
