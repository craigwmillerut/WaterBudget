...
!     Last change: CWM 10/5/2012 11:56:30 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
CALL REINI(2)
CALL REINI(3)
QX(3,J,K)=QX(2,J,K)+QX(1,J,K)+QX(27,J,K)
CALL ARSUB(2)
QX(27,J,K)=QX(32,J,K)+QX(7,J,K)
QX(30,J,K)=QX(29,J,K)+QX(27,J,K)
QX(10,J,K)=QX(30,J,K)+QX(9,J,K)
CALL ARSUB(1)
QX(17,J,K)=QX(14,J,K)+QX(15,J,K)
CALL MUNSUB(1)
QX(22,J,K)=QX(20,J,K)+QX(19,J,K)
CALL WETLND(1)
QX(24,J,K)=QX(22,J,K)-QX(23,J,K)
!Balance Flow
QX(26,J,K)=QX(24,J,K)+QX(25,J,K)
Diff=QIN(3,J,K)-QX(26,J,K)
DO WHILE (ABS(Diff).GT.0.1)
  CALL ARBAK(1)
  CALL ARBAK(2)
  QX(5,J,K)=0.0
  QX(7,J,K)=0.0
  ...
  QX(27,J,K)=MAX(0.0,Balance)
  QX(25,J,K)=MIN(0.0,Balance)
  QX(3,J,K)=QX(2,J,K)+QX(1,J,K)+QX(27,J,K)
  CALL ARSUB(2)
  QX(27,J,K)=QX(32,J,K)+QX(7,J,K)
  QX(30,J,K)=QX(29,J,K)+QX(27,J,K)
