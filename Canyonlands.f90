...
!     Last change: CWM 8/31/2012 2:32:10 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
CALL MUNSUB(1)
QX(17,J,K)=QX(10,J,K)+QX(16,J,K)
CALL WETLND(1)
!Does QX14 need to be solved for???
QX(14,J,K)=QX(10,J,K)-QX(13,J,K)
QX(11,J,K)=QX(12,J,K)-QX(14,J,K)
