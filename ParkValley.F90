...
!     Last change: SOU 3/27/2014 11:06:29 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
QX(40,J,K)=ARDEM(1)*0.25
QX(41,J,K)=QX(1,J,K)+QX(40,J,K)
CALL ARSUB(1)
QX(7,J,K)=QX(6,J,K)+QX(5,J,K)
QX(39,J,K)=ARDEM(2)*0.25
QX(9,J,K)=QX(8,J,K)+QX(39,J,K)
QX(11,J,K)=QX(9,J,K)+QX(10,J,K)
CALL MUNSUB(1)
QX(15,J,K)=QX(13,J,K)+QX(14,J,K)
QX(18,J,K)=QX(15,J,K)+QX(17,J,K)
CALL ARSUB(2)
QX(25,J,K)=QX(22,J,K)+QX(23,J,K)
QX(42,J,K)=ARDEM(3)*0.25
QX(43,J,K)=QX(26,J,K)+QX(42,J,K)
CALL ARSUB(3)
QX(32,J,K)=QX(30,J,K)+QX(31,J,K)
QX(33,J,K)=QX(32,J,K)+QX(25,J,K)
CALL WETLND(1)
QX(35,J,K)=QX(33,J,K)-QX(34,J,K)
QX(38,J,K)=QX(35,J,K)+QX(7,J,K)
QX(44,J,K)=.9*QX(38,J,K)
QX(45,J,K)=QX(38,J,K)-QX(44,J,K)
RETURN
END
