...
!     Last change: SOU 3/25/2015 6:22:00 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!Deep Creek
CALL REINI(1)
QX(9,J,K)=QX(8,J,K)+QX(6,J,K)
QX(10,J,K)=QX(4,J,K)+QX(9,J,K)
CALL MUNSUB(1)
QX(15,J,K)=QX(12,J,K)+QX(14,J,K)
CALL ARSUB(1)
QX(22,J,K)=QX(19,J,K)+QX(21,J,K)
CALL WETLND(1)
