...
!     Last change: EJ 10/17/2012 5:25:51 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
CALL REINI(1)
CALL MUNSUB(1)
QX(47,J,K)=ARDEM(1)*0.6
QX(6,J,K)=QX(5,J,K)+QX(4,J,K)+QX(47,J,K)
CALL ARSUB(1)
QX(13,J,K)=QX(12,J,K)+QX(11,J,K)
QX(14,J,K)=QX(15,J,K)-QX(13,J,K)
CALL MUNSUB(2)
QX(21,J,K)=QX(20,J,K)+QX(19,J,K)
CALL ARSUB(2)
QX(28,J,K)=QX(26,J,K)+QX(25,J,K)
QX(29,J,K)=QX(28,J,K)+QX(15,J,K)
QX(48,J,K)=ARDEM(3)*0.6
QX(31,J,K)=QX(30,J,K)+QX(29,J,K)+QX(48,J,K)
CALL ARSUB(3)
QX(38,J,K)=QX(36,J,K)+QX(35,J,K)
CALL MUNSUB(3)
QX(43,J,K)=QX(41,J,K)+QX(40,J,K)
CALL WETLND(1)
