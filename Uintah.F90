...
!     Last change: SOU 10/1/2013 8:17:38 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
!-----------------------------------------------------------------------
CALL REINI(1)
QX(17,J,K)=QX(2,J,K)-QX(18,J,K)
QX(5,J,K)=QX(4,J,K)+QX(3,J,K)
CALL MUNSUB(1)
QX(10,J,K)=QX(8,J,K)+QX(7,J,K)
QX(20,J,K)=QX(10,J,K)-QX(19,J,K)
QX(21,J,K)=QX(2,J,K)+QX(20,J,K)
CALL ARSUB(1)
QX(11,J,K)=QX(26,J,K)+QX(25,J,K)
CALL WETLND(1)
