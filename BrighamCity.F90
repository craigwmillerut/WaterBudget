...
!     Last change: EJ 9/19/2012 2:48:20 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
CALL ARSUB(1)
QX(7,J,K)=QX(4,J,K)+QX(5,J,K)
CALL MUNSUB(3)
QX(21,J,K)=QX(18,J,K)+QX(19,J,K)
CALL REINI(1)
QX(22,J,K)=ARDEM(2)
CALL ARSUB(2)
QX(29,J,K)=QX(26,J,K)+QX(27,J,K)
CALL MUNSUB(2)
QX(31,J,K)=QX(29,J,K)-QX(30,J,K)
QX(34,J,K)=QX(32,J,K)+QX(31,J,K)
CALL WETLND(1)
QX(15,J,K)=QX(38,J,K)-QX(16,J,K)
RETURN
END
