...
!     Last change: SOU 10/7/2013 7:29:19 AM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
REAL (KIND=8)::RSFLOW,DEM12,DEM13
!-----------------------------------------------------------------------
...
DEM12=WETDMD(1)
DEM13=DMDMD(1)
QX(7,J,K)=RSFLOW-DEM12-DEM13
CALL WETLND(1)
QX(9,J,K)=QX(7,J,K)-QX(8,J,K)
CALL MUNSUB(1)
QX(14,J,K)=QX(13,J,K)+QX(11,J,K)
CALL REINI(1)
QX(19,J,K)=QX(15,J,K)-QX(18,J,K)
QX(16,J,K)=QX(6,J,K)+QX(15,J,K)
QX(17,J,K)=QX(16,J,K)+QX(1,J,K)
RETURN
END
