...
!     Last change: CWM 9/25/2012 1:32:50 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
REAL (KIND=8):: DIFF, DIV,DIFFBEF
REAL (KIND=8) :: CANAL(13),CanalFactor,Division,Agdemand,Ripdemand
DATA CANAL/82.0,1.0,3*0.0,27.0,123.0,358.0,426.0,452.0,359.0,172.0,2000.0/
DATA CanalFactor/2.6/
DATA Division/.80/
!-----------------------------------------------------------------------
!     SAMPLE CODE FOR GENERAL MODEL
!-----------------------------------------------------------------------
QX(1,J,K)=ARDEM(1)
QX(2,J,K)=CANAL(K)*CanalFactor
QX(12,J,K)=QX(3,J,K)+QX(2,J,K)
QX(14,J,K)=QX(12,J,K)*Division
QX(26,J,K)=QX(12,J,K)*(1.0-Division)
CALL ARSUB(2)
CALL MUNSUB(1)
Agdemand=ARDEM(1)
Ripdemand=WETDMD(1)
QX(1,J,K)=QIN(1,J,K)+ARDEM(1)+WETDMD(1)
CALL ARSUB(1)
QX(11,J,K)=QX(8,J,K)+QX(9,J,K)
CALL WETLND(1)
!DIV=QX(5,J,K)
DIFF=QIN(1,J,K)-QX(11,J,K)+QX(21,J,K)
DIFFBEF=1.E9
DO WHILE ((ABS(DIFF).GT.0.1).AND.ABS(DIFF-DIFFBEF).GT.0.1)
    ...
    DIFFBEF=DIFF
    DIFF=QIN(1,J,K)-QX(11,J,K)+QX(21,J,K)
    !print *,"Diff = ",diff,"j,k = ",J,K," QX1 = ",QX(1,J,K)
END DO
QX(22,J,K)=QX(11,J,K)-QX(21,J,K)
QX(23,J,K)=QX(18,J,K)+QX(22,J,K)+QX(24,J,K)
CALL ARSUB(3)
RETURN
END
