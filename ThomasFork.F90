...
!     Last change: SOU 3/5/2015 5:10:40 PM
!     ******************************************************************
      SUBROUTINE LNDCLC
!-----------------------------------------------------------------------
!     SUBROUTINE LNDCLC
...
END IF
CALL ARSUB(1)
DIFF = QX(10,J,K)-(QX(9,J,K)+QX(7,J,K))
!DIFFBEF=DIFF
IF (ABS(DIFF) .gt. 0.3) THEN
        ...
        !IF (ABS(Diff) .LT. 0.1.OR.DIFF.EQ.DIFFBEF) Exit
        IF (ABS(Diff) .LT. 0.1) Exit
        !DIFFBEF=DIFF
        END DO
END IF
QX(11,J,K)=QX(36,J,K)+QX(37,J,K)+QX(38,J,K)
CALL ARSUB(2)
QX(18,J,K)=QX(15,J,K)+QX(17,J,K)
QX(19,J,K)=QX(10,J,K)+QX(18,J,K)
CALL MUNSUB(1)
